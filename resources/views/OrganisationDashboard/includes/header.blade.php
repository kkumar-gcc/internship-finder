    ...
    <div class="content-header content-header-fullrow">
      <form action="{{ url('/search') }}" method="GET" id="form_search">
        <div class="input-group">
          ...
          <input class="typeahead form-control" name="query" type="text" data-provide="typeahead" placeholder="Search or hit ESC.."
          id="input-group-append" autocomplete="off" value="{{ old('query') }}">
          <div class="input-group-append">
