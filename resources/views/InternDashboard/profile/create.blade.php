                        ...
                        <div class="col-lg-7 offset-lg-1">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    id="re-listing-name" name="first_name" placeholder="your first name">
                                <small class="form-text text-danger"
                                    style="font-size: 14px;">{!! $errors->first('first_name') !!}</small>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-danger"
                                    style="font-size: 14px;">{!! $errors->first('last_name') !!}</small>

                            </div>
                            <div class="form-group">
                                <label for="re-listing-address">Other Names</label>
                                <input type="text" class="form-control form-control-lg" id="re-listing-address"
                                    name="other_name" placeholder="your other names">
                                <small class="form-text text-danger"
                                    style="font-size: 14px;">{!! $errors->first('other_name') !!}</small>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <small class="form-text text-danger"
                                        style="font-size: 14px;">{!! $errors->first('gender') !!}</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <input type="date"
                                        class="form-control form-control-lg {{ $errors->has('date_of_birth') ? 'border-danger' : '' }}"
                                        id="re-listing-phone" name="date_of_birth" placeholder="E.g 1996-12-14">
                                    <small class=" form-text text-danger"
                                        style="font-size: 14px;">{{ $errors->first('date_of_birth') }}</small>
                                </div>
                            </div>
                            <div class="row items-push form-group">
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <input data-role="tagsinput" type="text" class="form-control form-control-lg"
                                        id="re-listing-phone" name="area_of_interest">
                                    <small class=" form-text text-danger"
                                        style="font-size: 14px;">{{ $errors->first('area_of_interest') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-7 offset-lg-1">
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text"
                                        ...
                                        id="re-listing-phone" name="phone">
                                    <small class="form-text text-danger"
                                        style="font-size: 14px;">{{ $errors->first('phone') }}</small>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <input type="number" class="form-control form-control-lg" id="re-listing-phone"
                                        name="house_number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text"
                                        class="form-control form-control-lg {{ $errors->has('city') ? 'border-danger' : '' }}"
                                        id="re-listing-phone" name="city">
                                    <small class="form-text text-danger"
                                        style="font-size: 14px;">{{ $errors->first('city') }}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text"
                                        class="form-control form-control-lg {{ $errors->has('state') ? 'border-danger' : '' }}"
                                        id="re-listing-phone" name="state">
                                    <small class="form-text text-danger"
                                        style="font-size: 14px;">{{ $errors->first('state') }}</small>
