<header id="page-header" style="margin-top: 2px;">
    <div class="content-header">
        <div class="content-header-section">
            ...
            <button type="button" class="btn btn-circle btn-dual-secondary d-sm-none" data-toggle="layout"
                data-action="header_search_on">
                <i class="fa fa-search"></i>
            </button>
            <div class="content-header-item d-none d-sm-inline-block">
                <form action="https://demo.pixelcave.com/codebase/db_medical.html" method="post"
        ...
        <div class="content-header-section">
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown"
                    ...
                    <span class="d-none d-sm-inline-block">{{auth()->user()->intern->first_name}} {{auth()->user()->intern->last_name}}</span>
