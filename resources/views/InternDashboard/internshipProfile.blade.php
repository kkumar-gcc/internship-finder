...
@section('content')
    <section class="section">
        ...
        @include('InternDashboard.organization.apply');
                    ...
                    <div class="card ">
                        <div>
                            <div class="job-details-compnay-profile">
                                <img src="{{ asset('ProfilePhoto') }}/i{{ $internship->id }}.jpg" alt=""
                                    style="width: 100%; height:300px;" class="rounded-3">
                            </div>
                        </div>
                        <div class="card-body p-4">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <ul class="list-inline text-muted mb-0">
                                            ...
                                            <li class="list-inline-item text-warning review-rating">
                                                <span class="badge bg-warning text-light">4.8</span> <i
                            ...
                            <div class="mt-4">
                                ...
                                <div class="job-detail-desc">
                                    <p class="text-muted mb-0">As a Product Designer, you will work within a Product
                                        Delivery Team fused with UX, engineering, product and data talent. You will help the
                                        team design beautiful interfaces that solve business challenges for our clients. We
                                        work with a number of Tier 1 banks on building web-based applications for AML, KYC
                                        and Sanctions List management workflows. This role is ideal if you are looking to
                                        segue your career into the FinTech or Big Data arenas.</p>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="job-detail-desc mt-2">
                                    ...
                                    <ul class="job-detail-list list-unstyled mb-0 text-muted">
                                        <li><i class="uil uil-circle"></i> Have sound knowledge of commercial activities.
                                        </li>
                                        <li><i class="uil uil-circle"></i> Build next-generation web applications with a
                                            focus on the client side</li>
                                        <li><i class="uil uil-circle"></i> Work on multiple projects at once, and
                                            consistently meet draft deadlines</li>
                                        <li><i class="uil uil-circle"></i> have already graduated or are currently in any
                                            year of study</li>
                                        <li><i class="uil uil-circle"></i> Revise the work of previous designers to create a
                                            unified aesthetic for our brand materials</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="job-detail-desc mt-2">
                                    <ul class="job-detail-list list-unstyled mb-0 text-muted">
                                        <li><i class="uil uil-circle"></i> B.C.A / M.C.A under National University course
                                            complete.</li>
                                        <li><i class="uil uil-circle"></i> 3 or more years of professional design experience
                                        </li>
                                        <li><i class="uil uil-circle"></i> have already graduated or are currently in any
                                            year of study</li>
                                        <li><i class="uil uil-circle"></i> Advanced degree or equivalent experience in
                            ...
                            <div class="mt-4">
                                ...
                                <div class="job-details-desc">
                                    <ul class="job-detail-list list-unstyled mb-0 text-muted">
                                        ...
                                        <li><i class="uil uil-circle"></i> Experience designing and developing responsive
                                            design websites</li>
                            ...
                            <div class="mt-4 pt-3">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item mt-1">
                                        <a href="javascript:void(0)" class="btn btn-primary btn-hover"><i
                                                class="uil uil-facebook-f"></i> Facebook</a>
                                    </li>
                                    <li class="list-inline-item mt-1">
                                        <a href="javascript:void(0)" class="btn btn-danger btn-hover"><i
                                                class="uil uil-google"></i> Google+</a>
                                    </li>
                                    <li class="list-inline-item mt-1">
                                        <a href="javascript:void(0)" class="btn btn-success btn-hover"><i
                    ...
                    <div class="side-bar ms-lg-4">
                        <div class="card job-overview">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3">
                                    {{-- <a type="button" href= "{{ $proposel->status != 'Apply' ? '/intern/internships/manage/'.auth()->user()->intern->id:'/intern/apply/'.Str::slug($internship->title).'/'.$internship->id  }}"  class="btn  btn-hover w-100 mt-2 {{$proposel->status != 'Apply' ? 'bg-soft-'.$color: 'btn-primary' }}"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasApply"
                                    aria-controls="offcanvasApply">{{ $proposel->status }} <i class="uil uil-arrow-right"></i></a> --}}
                                    @can('isNotActive')
                                        <button type="button" class="btn  btn-hover w-100 mt-2  btn-{{ $color }} "
                                            data-bs-toggle="offcanvas" data-bs-target="#offcanvasApply"
                                            aria-controls="offcanvasApply">{{ $proposel->status }} <i
                                                class="uil uil-arrow-right"></i></button>
                                    @endcan
                                    @can('isActive')
                                        <button type="button" class="btn  btn-hover w-100 mt-2  btn-{{ $color }} " disabled>You
                                            are Active on another internship <i class="uil uil-arrow-right"></i></button>
                                    @endcan

                                    <a href="bookmark-jobs.html" class="btn bg-warning btn-hover w-100 mt-2"><i
                        ...
                        <div class="card company-profile mt-4">
                            <div class="card-body p-4">
                                    ...
                                    <li class="mt-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <p class="text-muted fs-14 text-break mb-0">www.Jobcytechnology.pvt.ltd.com
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="mt-4">
                                    <a href="/intern/organizations/{{ $internship->organization->id }}"
